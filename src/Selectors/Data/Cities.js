export const Cities = {
    ...
    "Graf": {
        ...
        "Description": "This was once a small port city of native Prithans, a peaceful tribe who was no match for the raiding superiority of the proto-Grafken and were eliminated when the raiders decided to put down roots in their most recent conquest. Now, the capital of the Grafken Empire is its second largest city and sits along the bank of a large bay. On the opposite side of the bay, near the mouth, along the cliffs, is a virstone where a small outpost named Hawksmurth was founded to protect the artifact and has grown into a small town in peacetime."
    },
    "Nevin": {
    ...
    "Fallview": {
        ...
        "Description": "Originally an Alpos town, after the Alpian Liberation, the Empire heavily fortified and guarded the growing city to ensure control and utilization of the nearby virstone. "
    },
    "Termina": {
        ...
        "Description": "Name for both the large city as well as the massive columnar structure that acts as the seat of power for the Church of Daist in Celas (and arguably the Divide). Was founded by Dailand settlers after the calming of the L'rora's Emergence. Now that most denizens of Celasaan are Dais, the Matron, and by extension Termina, has substantial political power, even enough to maintain control of a virstone amidst Grafken lands."
    },
    "Eus": {
        "Pronunciation": "Youce",
    ...
    "Ramsmurth": {
        ...
        "Description": "A small, albeit fortified city near the “border” with the Quenn. Intended as a watchpoint for Quenn incursions, now, by taking advantage of nearby fauna and with new Quenn and even Dailand traders, the city is a bustling trade hub for northwest Celasaan."
    },
    "Dirth": {
        "Pronunciation": "Dirth",
        "Faction": "Quenn", 
        ...
        "Description": "Twin cities on opposite sides of the continent's northern half, each was founded not long after the Grafken Empire was formed and soon became bastions after the Empire began aggressively expanding."
    },
    "Forth": {
        "Pronunciation": "Forth",
        "Faction": "Quenn", 
    ...
    "Daiward": {
        ...
        "Description": "Actually founded before Termina, missionaries first landed here believing it was the mainland. Now a major international trading hub and serves as the main gateway for the riches leaving the Confluence."
    },
}