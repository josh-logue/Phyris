const Cities = {
  ...
  Eelsmurth: {
    ...
    Description:
      'The port city serving Nevin, this outpost serves as the main landing point for Grafken traders and military coming from Graf, the Old World, and the Drunken Archipelago.',
  },
  Whalsmurth: {
  ...
  Eus: {
    ...
    Population: 'Unknown - Grafken Estimation: ~100',
    Location: "Violence - Off Celasaan's Western Coast",
    Description:
      'Monastery of Vroth. Has never welcomed outsiders, so little is known by the Empire.',
  },
  Ramsmurth: {
  ...
  Dirth: {
    Faction: 'Quenn',
    Population:
      'Untracked - Grafken Estimation including surrounding camps: ~19,000',
    Location: 'Western Quenn Wilds',
    Description:
      'Western Twin city of Forth, founded not long after the Grafken Empire was formed and soon became bastions after the Empire began aggressively expanding.',
  },
  Forth: {
    Faction: 'Quenn',
    Population:
      'Untracked - Grafken Estimation including surrounding camps: ~24,000',
    Location: 'Central Quenn Wilds',
    Description:
      'Eastern Twin city of Dirth, founded not long after the Grafken Empire was formed and soon became bastions after the Empire began aggressively expanding.',
  },
  Squash: {
    Faction: 'Quenn',
    Population:
      'Point of contention for Grafken spies and scholars. Between 100 and 25,000 at any one time.',
    Location: 'Central Quenn Wilds - South of Forth',
    Description:
      'Outpost serving transient Quennish nomads and those preparing for a trek up to Forth',
  },
  Daiward: {
